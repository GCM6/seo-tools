...
export type EvidenceType = 'gsc' | 'ai_answer' | 'page_fetch' | 'render_check' | 'schema' | 'serp_snapshot' | 'manual' | 'sitemap' | 'site_audit' | 'psi' | 'dataforseo_serp' | 'dataforseo_labs' | 'dataforseo_backlinks' | 'ua_probe' | 'third_party_presence' | 'serp_aio' | 'social_presence'
